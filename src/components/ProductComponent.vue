    ...
    <div id="main">
      ...
      <div class="sidebar-contact js-sidebar-contact">
        ...
        <div class="sidebar-contact__content">
          <!-- Close -->
          <div class="sidebar-contact__close">
            <a href="#" class="js-close-sidebar-contact"><i class="lnil lnil-close"></i></a>
          </div>
          <!-- End close -->
          ...
          <div class="sidebar-contact__section">
            ...
            <div class="sidebar-contact-section__item d-flex">
              ...
              <!-- Text -->
              <div class="sidebar-contact-section-item__text">Call: +1 (202) 861-5567</div>
              <!-- End text -->
            </div>
            <!-- End item -->
            ...
            <div class="sidebar-contact-section__item d-flex">
              ...
              <!-- Text -->
              <div class="sidebar-contact-section-item__text">Email: support@demo.com</div>
              <!-- End text -->
            </div>
            <!-- End item -->
          </div>
          ...
          <div class="sidebar-contact__section">
            ...
            <ul class="sidebar-contact-section__socials">
              <li>
                <a href="https://twitter.com/" target="_blank"><i class="lnil lnil-twitter"></i></a>
              </li>
              <li>
          ...
          <div class="product__d-flex d-flex">
            ...
            <div class="product__content">
              ...
              <div class="product-breadcrumb__d-flex d-flex align-items-center">
                <!-- Breadcrumb -->
                <div class="product-breadcrumb__back-to-shop">
                ...
                <ul class="product-breadcrumb__prev-next d-flex align-items-center">
                  <li>
                    <a href="#"><i class="lnil lnil-chevron-left"></i><span>Prev</span></a>
                  </li>
                  <li>
                    <a href="#"><span>Next</span><i class="lnil lnil-chevron-right"></i></a>
                  </li>
                </ul>
                <!-- End prev / next -->
              </div>
              <!-- End d-flex -->
              <!-- Mobile share -->
              <div class="product__mobile-share">
                <a href="#"><i class="lnil lnil-share"></i></a>
              </div>
              <!-- End mobile share -->
              <!-- Product title -->
              ...
              <div class="product__options">
                  ...
                  <ul class="product__available-colors">
                    <li>
                      <a href="#" class="open-tooltip"
                        ><span class="custom-tooltip">Grey</span>
                        <p class="product-grid-item__color active" style="background: #484540">
                          <span style="border-color: #999"></span></p
                      ></a>
                    </li>
                    <li>
                      <a href="#" class="open-tooltip"
                        ><span class="custom-tooltip">Black</span>
                        <p class="product-grid-item__color" style="background: #191516">
                          <span style="border-color: #999"></span></p
                      ></a>
                    </li>
                  </ul>
                ...
                <div class="product__option d-flex align-items-center">
                  ...
                  <div class="product__quantity">
                    <div class="product-quantity__minus js-quantity-down">
                      <a href="#"><i class="lnil lnil-minus"></i></a>
                    </div>
                    <input
                      type="text"
                      value="2"
                    ...
                    />
                    <div class="product-quantity__plus js-quantity-up">
                      <a href="#"><i class="lnil lnil-plus"></i></a>
                    </div>
                  </div>
                  <!-- End quantity field -->
                </div>
              ...
              <ul class="product__second-action d-flex">
                <li>
                  <a href="#"><i class="lnil lnil-heart"></i> Add to wishlist</a>
                </li>
                <li>
                  <a href="#" class="hide-mobile-before"
                    ><i class="lnil lnil-reload"></i> Compare</a
                  >
                </li>
                <li class="d-none d-lg-block">
                  <a href="#"><i class="lnil lnil-share"></i> Share</a>
                </li>
              </ul>
              ...
              <ul class="product__information">
                ...
                <li>
                  <span>Tags</span>
                  <p>
                    <a href="#">shirt</a>, <a href="#">men</a>, <a href="#">basic</a>,
                    <a href="#">cotton</a>
                  </p>
                </li>
              </ul>
              ...
              <div class="product__mobile-tabs">
                ...
                <div class="accordion active js-accordion">
                  <!-- Title -->
                  <div class="accordion__title js-accordion-title">Description</div>
                  <!-- End title -->
                  <!-- Content -->
                  <div class="accordion__content js-accordion-content">
                    <h3>Introduce</h3>
                    <p>
                      Tailored line. Wool mix fabric. Long design. Long buttoned sleeve. Lapel with
                      notch. Back slit. Two pockets with flaps on the front. Button up. Inner
                      lining. Inner pocket. Back length 95.0 cm.
                    </p>
                    <h3>Material & Washing Instructions</h3>
                    <p>
                      Composition: 51% wool,45% polyester,2% acrylic,2% viscose.<br />Lining: 53%
                      cotton,47% polyester.<br />Sleeve lining: 100% polyester
                    </p>
                    <ul class="tab__features">
                      <li>
                        <p><img src="..assets/images/default/icon-washing.png" alt="Icon" /></p>
                        <span>No Washing</span>
                      </li>
                      <li>
                        <p><img src="..assets/images/default/icon-bleach.png" alt="Icon" /></p>
                        <span>do not bleach</span>
                      </li>
                      <li>
                        <p><img src="..assets/images/default/icon-ironing.png" alt="Icon" /></p>
                        <span>ironing max 110 0 c / 230 0 f</span>
                      </li>
                      <li>
                        <p>
                          <img src="..assets/images/default/icon-dry-cleaning.png" alt="Icon" />
                        </p>
                        <span>dry cleaning perchloroethylene</span>
                      </li>
                      <li>
                        <p><img src="..assets/images/default/icon-tumble-dry.png" alt="Icon" /></p>
                ...
                <div class="accordion js-accordion">
                  <!-- Title -->
                  <div class="accordion__title js-accordion-title">Ship & return</div>
                  <!-- End title -->
                  <!-- Content -->
                  <div class="accordion__content js-accordion-content">
                    <h3>Shipping</h3>
                ...
                <div class="accordion js-accordion">
                  <!-- Title -->
                  <div class="accordion__title js-accordion-title">Review (3)</div>
                  <!-- End title -->
                  <!-- Content -->
                  <div class="accordion__content js-accordion-content">
                    <!-- Review -->
                    <div class="review-2">
                      ...
                      <div class="review-2__details">
                        ...
                        <!-- End name -->
                        <!-- Content -->
                        <div class="review-2__content">
                          Thanks to the precious advice of the store owner, I choose this wonderful
                          product. I absolutely love it! Additionally, my order was sent very
                          quickly. I'm a happy customer and I'll order again!
                        </div>
                        <!-- End content -->
                        <!-- Meta -->
                    ...
                    <div class="review-2">
                      ...
                      <div class="review-2__details">
                        ...
                        <!-- Content -->
                        <div class="review-2__content">
                          I love it & certainly that i’ll buy it once again. Perfection experience!
                        </div>
                        <!-- End content -->
                        <!-- Meta -->
                        <div class="review-2__meta">
                    ...
                    <form class="review-2__form">
                      ...
                      <div class="form-checkbox">
                        ...
                        <label class="form-checkbox__label" for="checkbox1"
                          >Save my name & email in this browser for next time i comment</label
                        >
                      </div>
                      <!-- End form checkbox -->
                      <!-- Action -->
              ...
              <ul class="product__tabs d-flex">
                <li>
                  <a href="#" class="js-open-tab" data-id="1">Description</a>
                  <p class="pcontext">winter wear</p>
                </li>
                <li>
                  <a href="#" class="js-open-tab" data-id="2">Ship & return</a>
                  <p>2 days shipping</p>
                </li>
                <li>
                  <a href="#" class="js-open-tab" data-id="3">Review (3)</a>
                  <p class="pcontext">good</p>
                </li>
              </ul>
              <!-- End product tabs -->
              <!-- Tab description -->
                ...
                <div class="tab__content">
                  ...
                  <div class="tab__heading d-flex align-items-center">
                    ...
                    <div class="tab__close">
                      <a href="#" class="js-close-tab"><i class="lnil lnil-close"></i></a>
                    </div>
                    <!-- End close -->
                  </div>
                  <!-- End heading -->
                  ...
                  <div class="tab__description">
                    ...
                    <form class="review__form">
                      ...
                      <div class="form-checkbox">
                        ...
                        <label class="form-checkbox__label" for="checkbox2"
                          >Save my name & email in this browser for next time i comment</label
                        >
                      </div>
                      <!-- End form checkbox -->
        ...
        <div class="container">
          ...
          <div class="sticky-add-to-cart__d-flex d-flex align-items-center">
            ...
            <div class="sticky-add-to-cart__quantity">
              <div class="sticky-add-to-cart-quantity__minus js-quantity-down">
                <a href="#"><i class="lnil lnil-minus"></i></a>
              </div>
              <input
                type="text"
                value="2"
                class="sticky-add-to-cart-quantity__input js-quantity-field"
              />
              <div class="sticky-add-to-cart-quantity__plus js-quantity-up">
                <a href="#"><i class="lnil lnil-plus"></i></a>
              </div>
            </div>
            <!-- End quantity -->
          ...
          <div class="home-products__carousel js-home-products-5-carousel">
            ...
            <div class="product-grid-item">
              ...
              <div class="product-grid-item__image">
                <a href="product.html">
                  <img
                    ...
                    image-sizes="auto"
                    data-sizes="auto"
                    data-srcset="../assets/products/1/2_1-a.jpg 50w,
                   ../assets/products/1/2_1-a.jpg 200w"
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                    class="lazyload lazy-effect"
                  />
                  <img
              ...
              <div class="product-grid-item__title">
                <a href="product.html">Zipped cotton cardigan</a>
              </div>
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Basic T-shitt with slogan</a>
              </div>

              <!-- End title -->
              <!-- Price -->
              <div class="product-grid-item__price">$32.5</div>
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Grey nubuck leather high-top deck shoes</a>
              </div>
              <!-- End title -->
              <!-- Price -->
              <div class="product-grid-item__price">$79.9 - $459.5</div>
              <!-- End price -->
            </div>
            <!-- End product -->
          </div>
        ...
        <div class="home-products__container">
          ...
          <div class="home-products__carousel js-home-products-5-carousel">
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Hand cleaner gel pure bergamot</a>
              </div>
              <!-- End title -->
              <!-- Price -->
              <div class="product-grid-item__price">$32.5</div>
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Chrome acetate sunglasses</a>
              </div>
              <!-- End title -->
              <!-- Rating -->
              ...
              <!-- End rating -->
              <!-- Price -->
              <div class="product-grid-item__price">$72.9</div>
              <!-- End price -->
              <!-- Action -->
              <div class="product-grid-item__action d-flex">
                <!-- Button -->
        ...
        <div class="home-products__container">
          ...
          <div class="home-products__title-and-action d-flex">
            ...
            <div class="home-products__action">
              <a href="shop.html">View all <i class="lnil lnil-chevron-right"></i></a>
            </div>
            <!-- End action -->
          </div>
          <!-- End title and action -->
          ...
          <div class="home-products__carousel js-home-products-2-carousel">
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Crew neck cotton sweatshirt</a>
              </div>
              <!-- End title -->
              <!-- Rating -->
              <div class="product-grid-item__rating">
              ...
              <!-- End rating -->
              <!-- Price -->
              <div class="product-grid-item__price">$79.9</div>
              <!-- End price -->
              <!-- Action -->
              <div class="product-grid-item__action d-flex">
                <!-- Button -->
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Chonograph Watch with leather belt</a>
              </div>
              <!-- End title -->
              <!-- Rating -->
              <div class="product-grid-item__rating">
              ...
              <!-- End rating -->
              <!-- Price -->
              <div class="product-grid-item__price">$149.5</div>
              <!-- End price -->
              <!-- Tag -->
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">100% wool twill scarf</a>
              </div>
              <!-- End title -->
              <!-- Price -->
              <div class="product-grid-item__price">$79.9 - $459.5</div>
            ...
            <div class="product-grid-item">
              ...
              <!-- Title -->
              <div class="product-grid-item__title">
                <a href="product.html">Brown leather wallet in box style</a>
              </div>
              <!-- End title -->
              <!-- Rating -->
              <div class="product-grid-item__rating">
      ...
      <div
        class="home-products home-products--type-8 home-products--recently-viewed home-products--complete-your-outfit"
      >
        <!-- Container -->
        <div class="container">
          <!-- Products container -->
      ...
      <!-- Home products -->
      <div
        class="home-products home-products--type-8 home-products--recently-viewed home-products--similar-pieces"
      >
        <!-- Container -->
        <div class="container">
          <!-- Products container -->
          ...
          <div class="search-popups__results">
            ...
            <div class="search-popups__results-products d-flex">
              ...
              <div class="product-grid-item">
                ...
                <!-- Title -->
                <div class="product-grid-item__title">
                  <a href="product.html">Brown nubuck leather high-top deck shoes</a>
                </div>
                <!-- End title -->
                <!-- Rating -->
                <div class="product-grid-item__rating">
...
export default {
  ...
  mounted() {
    ...
    script1.src = '/assets/js/vendor7b30.js?v=4'
    script1.async = true
    document.body.appendChild(script1)

    const script2 = document.createElement('script')
    script2.src = '/assets/js/theme7b30.js?v=4'
    script2.async = true
