...
<template>
    <body class="bg-gray-100 text-gray-800 font-sans">
        <Navbar/>
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-16">
        <h1 class="text-2xl font-bold mb-4">Cancellation & Refund Policy <hr class="w-auto " style="height: 3px;"></h1>
        <p class="mb-4">Last updated on Jun 5th 2024</p>

        <p class="mb-4">ALLSKY FOOTWEAR PRIVATE LIMITED believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p>
        ...
        <ul class="list-disc ml-6 mb-4 space-y-2">
            ...
            <li>ALLSKY FOOTWEAR PRIVATE LIMITED does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
            ...
            <li>In case of any Refunds approved by ALLSKY FOOTWEAR PRIVATE LIMITED, it will take 3-5 days for the refund to be processed to the end customer.</li>
        </ul>
    </div>
    <Footer/>
</body>
